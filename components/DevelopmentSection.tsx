...
const DevelopmentSection = ({className}: {className?:string}) => {
  return (
    <Section className={cn("", className)}>
      <Container className="lg:grid lg:grid-cols-[1.4fr_1fr] lg:gap-6">
        ...
        >
          <div>
            ...
            <h3 className="scroll-m-20 mt-3 text-3xl lg:text-4xl text-primary font-semibold">
              <Translate id="home.development_section.title" />
            </h3>
          </div>

          <p className="text-lg leading-8 font-light">
            <Translate id="home.development_section.p1" />
          </p>
      ...
      <div className=" opacity-10 lg:opacity-100">
        <motion.div
          ...
          style={{
            backgroundImage: 'url("/man-office-frame.png")',
            backgroundSize: "cover",
            backgroundRepeat: "no-repeat",
            backgroundPosition: "center center"
          }}
